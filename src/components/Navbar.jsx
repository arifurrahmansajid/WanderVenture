    ...
    <div className="text-black dark:text-white bg-card dark:bg-gray-500">
      <div className="navbar sm:w-[97%] sm:mx-auto">
        <div className="navbar-start">
          ...
          <Link
            to="/"
            className="btn btn-ghost text-xl md:text-2xl lg:text-3xl hover:bg-violet-500 font-poppins hover:text-white -ml-3 md:ml-3 px-1 md:px-3"
          >
           WanderVenture
          </Link>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal font-poppins px-1 space-x-3">{links}</ul>
        </div>
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="btn font-poppins btn-secondary bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-[#f04970] sm:text-lg text-white"
                >
                  Logout
                </button>
              </>
