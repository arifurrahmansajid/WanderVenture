  ...
  return (
    <div data-aos="fade-up" className="mx-2 my-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row text-center lg:text-left text-black ">
        <div className="p-3">
          <h2 data-aos="fade-down" data-aos-delay={100} className="text-3xl lg:text-4xl font-poppins font-semibold text-black dark:text-gray-100">Introducing A Travel Spot Gallery</h2>
          ...
          <Link to='/allSpot' className="btn btn-primary bg-violet-500 text-white font-poppins mt-5">Explore More</Link>
        </div>
