    ...
    <div className="relative">
      ...
      >
        <div className=" h-[40%] max-w-[900px] text-white p-5">
          <h1 className="text-2xl dark:text-gray-200 md:text-5xl uppercase font-poppins ">
            {" "}
            <Typewriter
              words={[
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/allspot"
              className=" mt-2 p-2 border font-poppins border-blue-500 rounded-md text-sm lg:text-base"
            >
              Explore More
            </Link>
          </div>
