  ...
  return (
    <div className="mt-10">
      <div className="max-w-7xl mx-auto">
        <h1
          data-aos="fade-down"
          className="text-3xl lg:text-5xl font-bold font-poppins text-center mt-7 my-3 text-gray-900 dark:text-gray-100"
        >
          Countries Section
        </h1>
        <p data-aos="fade-down" data-aos-delay={100} className="text-center font-poppins text-black dark:text-gray-100">
