    ...
    <div className="my-10 mx-2">
      <div className="max-w-7xl mx-auto ">
        <h2
          data-aos="fade-down"
          data-aos-delay={300}
          className="text-2xl mb-7 sm:text-3xl  font-poppins text-black dark:text-gray-100 font-semibold text-center"
        >
          What People Say
        </h2>
        <div
        ...
        >
          <div className="max-w-md mx-auto p-6 overflow-hidden rounded-lg shadow bg-card dark:bg-gray-600 text-black dark:text-gray-200">
            <article>
              ...
              <p className=" text-xl text-black dark:text-gray-200 font-poppins">
              ...
              <div className="flex items-center mt-8 space-x-4">
                ...
                />
                <div>
                  <h3 className="text-sm font-medium font-poppins">Mark Stivens</h3>
          ...
          <div className="max-w-md mx-auto p-6 overflow-hidden rounded-lg shadow bg-card text-black dark:bg-gray-600 dark:text-gray-200">
            <article>
              ...
              <div className="flex items-center mt-8 space-x-4">
                ...
                />
                <div>
                  <h3 className="text-sm font-medium font-poppins">Michael Green</h3>
                  <p className="text-sm text-black dark:text-gray-300 font-poppins">Los Angeles</p>
                </div>
              </div>
            </article>
          </div>
          <div className="max-w-md mx-auto p-6 overflow-hidden rounded-lg shadow dark:bg-gray-600 dark:text-gray-200 bg-card text-black">
            <article>
              ...
              <div className="flex items-center mt-8 space-x-4">
                ...
                />
                <div>
                  <h3 className="text-sm font-medium font-poppins">Wendy Moore</h3>
