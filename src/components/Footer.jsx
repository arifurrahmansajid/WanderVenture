  ...
  return (
    <footer data-aos="fade-up"  className="px-4 divide-y bg-gray-900 text-gray-100">
      <div className="container max-w-7xl flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <Link to="/" className="flex justify-center lg:justify-start">
            ...
            <span className="self-center font-poppins text-2xl font-semibold">
            WanderVenture
            </span>
          </Link>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide font-poppins font-semibold uppercase text-gray-50">
              All Travel Services
            </h3>
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase font-poppins text-gray-50 font-semibold">Company</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Privacy
          ...
          <div className="space-y-3">
            <h3 className="uppercase font-semibold text-gray-50 font-poppins">Contact Us</h3>
            <ul className="space-y-1">
              <li>
                <a
              ...
              <li>
                ...
                >
                  ...
                  <span className="ml-1">6000, Dhaka, BD</span>
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        © 2024 WanderVenture All rights reserved.
      </div>
    </footer>
  );
};
