  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center h-[150px] sm:h-[300px] object-cover bg-cover bg-[linear-gradient(45deg,rgba(0,0,0,0.5),rgba(0,0,0,0)),url('https://i.ibb.co/qjryrqM/details.jpg')] bg-center bg-no-repeat">
        <h2
          data-aos="fade-down"
          className="text-2xl sm:text-3xl lg:text-5xl text-white font-poppins capitalize"
        >
          {spotName}
        </h2>
        <p
          data-aos="fade-up"
          data-aos-delay={100}
          className="text-sm mt-2 text-center text-white font-poppins"
        >
          Details Page
        </p>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div data-aos="fade-up" className=" gap-5 mt-10 ">
            <div className="title-and-text">
              <h1 className="text-3xl text-black dark:text-gray-100 font-poppins  font-bold  capitalize">
                {spotName}
              </h1>
          ...
          <div className="">
            <h3
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-2xl text-black dark:text-gray-100 font-bold  mt-10 uppercase font-poppins"
            >
          ...
          >
            <div className="overflow-x-auto max-w-[600px] font-poppins">
          ...
          <div className=" my-5">
            <h1 data-aos="fade-up"
              data-aos-delay="200"
              className="text-2xl text-black dark:text-gray-100 font-bold  mt-10 uppercase font-poppins">Contact info</h1>
            <div data-aos="fade-up"
              data-aos-delay="200"
              className="text-base text-black dark:text-gray-200 font-bold  mt-10 font-poppins">
