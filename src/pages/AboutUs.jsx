  ...
  return (
    <div>
      ...
      <div className=" flex flex-col items-center justify-center h-[300px]  object-cover bg-cover bg-[linear-gradient(45deg,rgba(0,0,0,0.5),rgba(0,0,0,0)),url('https://i.ibb.co/LQJyYDZ/aboutus.jpg')] bg-center bg-no-repeat">
        <h2
          data-aos="fade-down"
          className="text-2xl sm:text-4xl lg:text-5xl font-poppins text-white dark:text-gray-200"
        >
          About Us
        </h2>
        <span
        ...
        <div className="max-w-7xl mx-auto">
          <div className="my-10">
            <h2
              data-aos="fade-up"
              data-aos-delay={100}
              className="text-2xl mb-3 sm:text-3xl font-poppins text-black dark:text-gray-100 font-semibold text-center"
            >
              About Our Company
            </h2>
            <p
              data-aos="fade-up"
              data-aos-delay={200}
              className="text-center text-gray-800 dark:text-gray-300 text-lg font-poppins"
            >
          ...
          >
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
              ...
              >
                <h1 className="text-4xl dark:text-gray-100 font-poppins font-bold">Get in touch</h1>
                <p className="pt-2 dark:text-gray-200 pb-4 font-poppins">
                ...
                <div className="space-y-4 dark:text-gray-200">
                  ...
                  <p className="flex items-center">
                    ...
                    <span>info@WanderVenture.com</span>
                  </p>
                </div>
              </div>
              <form
          ...
          >
            <h2 className="text-2xl mb-7 sm:text-3xl  font-poppins text-black dark:text-gray-100 font-semibold">
