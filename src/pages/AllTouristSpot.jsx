...
const AllTouristSpot = () => {
  ...
  return (
    <div>
      ...
      <p data-aos="fade-down" data-aos-delay={100} className="text-center text-gray-900 dark:text-gray-200 font-poppins">
      All the favorite tourist spot here.
        ...
        <div className="my-8 grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-5 font-poppins">
          {spotInfo.map((spot) => (
