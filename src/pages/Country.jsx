    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <h2
          data-aos="fade-down"
          data-aos-delay={100}
          className="text-3xl mt-10 lg:text-4xl font-poppins dark:text-gray-100 text-gray-900 font-semibold text-center"
        >
          {country._id} 
        </h2>
        <p
          data-aos="fade-down"
          data-aos-delay={150}
          className="md:text-lg mt-2 text-center dark:text-gray-200 text-gray-800 font-poppins"
        >
