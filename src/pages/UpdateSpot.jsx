...
const UpdateSpot = () => {
  ...
  return (
    <div className="mx-2">
      ...
      <p className="text-center text-gray-800 font-poppins dark:text-gray-200">Edit the data to update your tourist spot.</p>
      <div className="max-w-7xl mx-auto">
        <div>
          ...
          >
            ...
            >
              <div className="">
                <label htmlFor="spotName" className="text-sm font-poppins text-gray-800 dark:text-gray-200">
                  Spot Name
                </label>
                <input
                  {...register("spotName")}
