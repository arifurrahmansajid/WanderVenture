...
const Register = () => {
  ...
  return (
    <div className="mx-2">
      ...
      >
        <h1 className="text-2xl font-bold text-center text-black dark:text-gray-100 font-poppins">Register Now!</h1>
        <form onSubmit={handleSubmit(onSubmitRegister)} className="space-y-6">
          ...
          <div className="space-y-1 text-sm">
            <label htmlFor="username" className="block text-gray-800 dark:text-gray-200 font-poppins">
              Photo URL
            </label>
            <input
              {...register("photoURL", {
        ...
        <p className="text-sm text-center sm:px-6 text-gray-800 dark:text-gray-200 font-poppins">
          Have an account?
          <Link to="/login" className="underline font-bold text-gray-800 dark:text-gray-50 ml- font-poppins">
            Login
          </Link>
        </p>
      </div>
